...
void imprimir(int ganhador, Sapo *sapo){
	if(ganhador==1){
		...
		cout << sapo[1].getname()<<": "<< "Pulos: "<<sapo[1].getpulos()<<" Distância percorrida no momento da chegada do sapo vencedor: "<<sapo[1].getdistancia()<<"m"<<endl;
		cout << sapo[2].getname()<<": "<< "Pulos: "<<sapo[2].getpulos()<<" Distância percorrida no momento da chegada do sapo vencedor: "<<sapo[2].getdistancia()<<"m"<<endl;
	}
	if(ganhador==2){
		cout <<"***************************************************"<<endl;
		...
		cout << "Detalhes da corrida:" << endl;
		cout<<endl;
		cout << sapo[0].getname()<<": "<< "Pulos: "<<sapo[0].getpulos()<<" Distância percorrida no momento da chegada do sapo vencedor: "<<sapo[0].getdistancia()<<"m"<<endl;
	...
	if(ganhador==3){
		...
		cout <<endl;
		cout << sapo[0].getname()<<": "<< "Pulos: "<<sapo[0].getpulos()<<" Distância percorrida no momento da chegada do sapo vencedor: "<<sapo[0].getdistancia()<<"m"<<endl;
		cout << sapo[1].getname()<<": "<< "Pulos: "<<sapo[1].getpulos()<<" Distância percorrida no momento de chegada do sapo vencedor: "<<sapo[1].getdistancia()<<"m"<<endl;
